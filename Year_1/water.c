...
// NOW IT IS YOUR TURN, WRITE BELOW THE CODE FOR COMPUTING THE BILL AND UPDATING CUMULATIVE VALUES
	// bill for current customer
	if(CustomerType == 1)
	{
		numbOfDomCustomers = numbOfDomCustomers + 1;
	}
	// Fresh water charge
	if(QWaterConsumption >= 1 && QWaterConsumption <= 5 && CustomerType != 2)
	{
		QFreshWaterCharge = QWaterConsumption * 0.2;
	}
	else if(QWaterConsumption >= 6 && QWaterConsumption <= 12 && CustomerType != 2)
	{
		QFreshWaterCharge = ((QWaterConsumption - 5) * 0.35) + 1;
	}
	else if(QWaterConsumption >= 13 && QWaterConsumption <= 25 && CustomerType != 2)
	{
		QFreshWaterCharge = ((QWaterConsumption - 12) * 0.5) + 3.45;
	}
	else if(QWaterConsumption >= 26 && QWaterConsumption <= 40 && CustomerType != 2)
	{
		QFreshWaterCharge = ((QWaterConsumption - 25) * 0.75) + 9.95;
	}
	else if(QWaterConsumption > 40 && CustomerType != 2)
	{
		QFreshWaterCharge = ((QWaterConsumption - 40) * 2.50) + 21.20;
	}
	...
	if(CustomerType == 1)
	{
		QStandingCharges = 91 * 0.10;
	}
	else
	{
		QStandingCharges = 91 * 1.30;
	}
	...
	if(QAmountToPay > QMaxDomesticBill && CustomerType == 1)
	{
